...
public class OrdersStore {
     ...
     * @param order Заказ.
     * @return true, если заказ обновлен успешно, иначе false.
     */
    ...
    /**
     * Метод возвращает все заказы из БД.
    ...
    /**
     * Метод ищет заказ по его идентификатору.
    ...
    /**
     * Метод ищет заказ по его наименованию.
